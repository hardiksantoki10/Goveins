...
import com.goviens.android.models.ModelResultCheck;
...
public class ApiManager {
    ...
    public void execution_method_get(final String tag, String url) {
        ...
        AndroidNetworking.get(url)
            ...
            public void onError(ANError anError) {
                ...
                apifetcher.onAPIRunningState(APIFETCHER.KEY_API_IS_ERRORED, tag);
            }
        });
    }
    ...
    @SuppressLint("LongLogTag")
    public void _post(final String tag, String url, HashMap<String, String> bodyparameter, final SessionManager sessionManager) throws Exception {
        Log.d(tag + " **Body API_S Posting parameter ==> ", "" + bodyparameter);
        Log.d(tag + " **Url API_S Url executed ==> ", "" + url);
        ...
        AndroidNetworking.post("" + url)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(final JSONObject jsonObject) {
                        ...
                        ModelResultCheck resultCheck = SingletonGson.getInstance().fromJson("" + jsonObject, ModelResultCheck.class);
                        apifetcher.onAPIRunningState(APIFETCHER.KEY_API_IS_STOPPED, tag);
                    ...
                    public void onError(ANError anError) {
                        if (anError.getErrorDetail().equals("connectionError")) {
                            ...
                            apifetcher.onFetchResultZero(anError.getErrorDetail(), tag);
                        }
                        apifetcher.onAPIRunningState(APIFETCHER.KEY_API_IS_STOPPED, tag);
...
//                        apifetcher.onFetchResultZero("" + anError.getErrorDetail());
    ...
    @SuppressLint("LongLogTag")
    public void _post_image(final String tag, String url, HashMap<String, String> bodyparameter, HashMap<String, File> fileparams, final SessionManager sessionManager) throws Exception {
        Log.d(tag + " **Body API_S Posting parameter ==> ", "" + bodyparameter);
        Log.d(tag + " **Url API_S Url executed ==> ", "" + url);
        Log.d("" + tag, "" + sessionManager.getHeader());
        Log.d("" + tag, "locale:" + sessionManager.getLanguage());
